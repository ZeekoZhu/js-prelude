...
export function useControlProps<T, TControlValue>(field: AbstractFormField<T>, options: UseControlProps<T, TControlValue>) {
...
export function useHtmlControlProps<T extends string>(field: AbstractFormField<T>, options: UseControlProps<T, React.ChangeEvent<{ value: T }>>) {
  return useControlProps(field, {
    ...options,
    transformControlValue: (value: React.ChangeEvent<{ value: T }>) => value.currentTarget.value,
  });
}
